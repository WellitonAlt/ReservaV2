...
public class NovoHotelMaquinaEstados implements Serializable{
    ...
    public static NovoHotelMaquinaEstados usuarioExistente() {
        return new NovoHotelMaquinaEstados(false, false, true, true, false, true, false, false);
    }
    
    public static NovoHotelMaquinaEstados usuarioExistenteSenhaCorreta() {
        return new NovoHotelMaquinaEstados(false, false, true, false, false, false, false, false);
    }
    
    public static NovoHotelMaquinaEstados usuarioInexistente() {
        return new NovoHotelMaquinaEstados(false, true, false, false, false, false, false, false);
    }

    public static NovoHotelMaquinaEstados confirmarHotelUsuarioExistente() {
        return new NovoHotelMaquinaEstados(false, true, false, false, true, false, false, true);
    }
    
    public static NovoHotelMaquinaEstados confirmarHotelUsuarioInexistente() {
